...
export const slides = [
  ...
  export const socialLinks = [
    { icon: Facebook, href: "https://www.facebook.com/share/178719nNrV/?mibextid=wwXIfr", color: "hover:text-blue-600" },
    { icon: Instagram, href: "#", color: "hover:text-pink-600" },
    { icon: Linkedin, href: "#", color: "hover:text-blue-700" },
    { icon: Linkedin, href: "https://www.tiktok.com/@miracle.care.camp3?_t=ZS-8zbeGsyGpBI&_r=1", color: "hover:text-blue-700" },
  ];
  ...
  export  const courses = [
   ...
   export const images = [
    ...
    export const FeaturedCoursesArr = [
    {
      ...
      description: 'Comprehensive nursing programs with hands-on clinical training',
    ...
    },
    {
      ...
      description: 'Professional caregiver training for elderly and disability care',
    ...
    },
    {
      ...
      description: 'Professional pharmacy operations and customer service training',
      features: ['Medication Knowledge', 'Customer Service', 'Inventory Management'],
